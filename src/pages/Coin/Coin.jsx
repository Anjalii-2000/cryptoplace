...
const Coin = () => {
  ...
  const fetchCoinData = async () => {
    const options = { method: 'GET', headers: { 'x-cg-demo-api-key': 'CG-xhfB9jaeBhyNQ2ras3rd1WWP' } };

    fetch(`https://api.coingecko.com/api/v3/coins/${coinId}`, options) // ✅ FIX
  ...
  const fetchHistoricalData = async () => {
    const options = {
      method: 'GET',
      headers: { 'x-cg-demo-api-key': 'CG-xhfB9jaeBhyNQ2ras3rd1WWP' }
    };
